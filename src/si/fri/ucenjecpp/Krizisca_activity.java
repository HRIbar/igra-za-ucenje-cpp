...
@SuppressLint("NewApi")
public class Krizisca_activity extends Activity implements OnClickListener  {
	TextView editNickname, editTocke, editSekunde;
	int timeLeft = 30;
	int tocke;
	String nickname = User.nickname;
	Timer timerOne = new Timer();
	String[] imageArray = {"krizisce1d","krizisce2a","krizisce3c","krizisce4a","krizisce5c","krizisce6b","krizisce7a",
			"krizisce8b","krizisce9b","krizisce10a","krizisce11c","krizisce12d","krizisce13c","krizisce14c","krizisce15a",
			"krizisce16c","krizisce17b","krizisce18c","krizisce19b","krizisce20d","krizisce21a","krizisce22d","krizisce23b",
			"krizisce24b","krizisce25a","krizisce26c","krizisce27c","krizisce28d","krizisce29a","krizisce30c","krizisce31b",
			"krizisce32c","krizisce33b","krizisce34a","krizisce35c"}; //zadna crka predstavlja pravilen odgovor
