...
@SuppressLint("NewApi")
public class Avtocesta_activity extends Activity implements OnClickListener  {
	TextView editNickname, editTocke, editSekunde;
	int timeLeft = 30;
	int tocke;
	String nickname = User.nickname;
	Timer timerOne = new Timer();
	String[] imageArray = {"avtocesta1b","avtocesta2b","avtocesta3a","avtocesta4a","avtocesta5a",
			"avtocesta6b","avtocesta7a","avtocesta8a","avtocesta9b","avtocesta10c"}; //zadna crka predstavlja pravilen odgovor
